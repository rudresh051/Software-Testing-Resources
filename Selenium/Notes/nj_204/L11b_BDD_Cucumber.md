...
// copy from src to file extension  and give path of feature file
// give the package name of step_definitions in glue
// just copy paste the plugin given below.
@CucumberOptions(features = {"src/test/resources/login/login.feature"}, glue = "step_definitions"
...
![Cucumber-TestNG-folderStructure](image-29.png)